...
#from graphics.formats import png <- explicit but names the package
# be more package name agnostic
# from .formats import png <- either works
...
import sys
import os
sys.path.insert(0,os.path.join ( os.path.join (os.path.dirname (__file__), "..") ,"contrib" ))
